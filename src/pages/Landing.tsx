    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 to-emerald-900 text-white">
      ...
      <div className="relative container mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <Link to="/dashboard" className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 px-8 py-4 rounded-xl font-bold text-lg shadow-xl hover:scale-105 transition-all">
            Start Trading →
          </Link>
          
          <Link to="/leagues" className="border-2 border-emerald-400 text-emerald-400 hover:bg-emerald-400 hover:text-slate-900 px-8 py-4 rounded-xl font-bold text-lg hover:scale-105 transition-all">
            Join League
          </Link>

          <Link to="/contracts" className="border-2 border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-slate-900 px-8 py-4 rounded-xl font-bold text-lg hover:scale-105 transition-all">
            Options Analyzer
          </Link>
        </div>
